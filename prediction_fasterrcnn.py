...
def plot_img(image_name, plot_results):
    ...
    ax[1].set_title('Image with Prediction from Faster RCNN')
    ax[1].imshow(image2)

    plt.show()

target_file = "3824.png"
...
checkpoint = torch.load("trained_models/fasterrcnn/checkpoint_99.pth", map_location=torch.device('cpu'))
